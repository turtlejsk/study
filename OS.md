...
## 1.4. Process
  ...
  #### 1.4.2.3. Context Switching
    - 프로세스를 실행하는 과정의 프로세스 정보는 CPU 내의 레지스터에 저장하고 있다.
    - Swapping
    - PCB에 수행되던 레지스터 값들이 저장된다.

  #### 1.4.2.4. IPC(Inter-Process Communication)
    - Cooperating process 사이에서 데이터를 주고 받는 행위
    
  ##### 1.4.2.4.1. Cooperating process를 사용하는 이유
      1. Information sharing
      2. Computation speedup
      3. Modularity
      4. Convenience

  ##### 1.4.2.4.2. Message passing
  ...
  ##### 1.4.2.4.3. Shared Memory
    - 두 프로세스 간의 공유된 메모리를 생성 후 이용
    - 동기화 문제 발생 가능성 있음
    
  ##### 1.4.2.4.4. 생산자-소비자 문제
...
## 1.6. Process scheduling
  ...
  ### 1.6.5. SRTF(Shortest Remaining Time First)
    - SJF와 같지만 수행시키던 프로세스를 중단시키고 다른 프로세스를 실행할 수 있다.

  ### 1.6.6. Priority Scheduling
  ...
  ### 1.6.8. Multilevel Queue
    - 어떤 프로세스냐에 따라서 여러 종류의 그룹으로 나누고 여러 개의 큐에 다양한 알고리즘을 적용

  ### 1.6.9. Multilevel Feedback Queue
